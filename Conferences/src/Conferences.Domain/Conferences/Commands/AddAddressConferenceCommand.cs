...
{
    public class AddAddressConferenceCommand : Command
    {
        ...
        public AddAddressConferenceCommand(Guid id, string address1, string address2, string address3, string number,
