...
{
    public class AddressConferenceAddedEvent : Event
    {
        ...
        public AddressConferenceAddedEvent(Guid addressId, string address1, string address2, string address3, string number, 
